export const courses: { name: string, img: string, price: number; teacher: string, teachershort: string, teacherlong: string, locationshort: string, locationlong: string, duration: number, availability: boolean, id: number, quantity: number }[] = [{
    ...
    teachershort: "Bogdan, a seasoned software engineer, brings a wealth of industry experience to the programming course.",
    ...
    price: 3200,
    teacher: "Bogdan Moisoiu",
    teachershort: "Bogdan, an expert in algorithm design, equips students with advanced problem-solving techniques.",
